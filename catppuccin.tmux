...
main() {
  ...
  readonly show_directory_in_window_status="#[fg=$thm_blue,bg=default]$right_separator#[fg=$thm_bg,bg=$thm_blue] #I #[fg=$thm_fg,bg=$thm_gray] #W #[fg=$thm_blue,bg=default]$left_separator#[fg=$thm_fg,bg=default] "
  ...
  readonly show_directory_in_window_status_current="#[fg=$thm_orange,bg=default]$right_separator#[fg=colour232,bg=$thm_orange] #I #[fg=colour255,bg=colour237] #(echo '#{pane_current_path}' | rev | cut -d'/' -f-2 | rev) #[fg=$thm_orange,bg=default]$left_separator#[fg=$thm_fg,bg=default] "

  local show_window_in_window_status
  readonly show_window_in_window_status="#[fg=$thm_blue,bg=default]$right_separator#[fg=$thm_fg,bg=$thm_gray] #W #[fg=$thm_bg,bg=$thm_blue] #I#[fg=$thm_blue,bg=default]$left_separator#[fg=$thm_fg,bg=default,nobold,nounderscore,noitalics] "

  local show_window_in_window_status_current
  readonly show_window_in_window_status_current="#[fg=$thm_orange,bg=default]$right_separator#[fg=$thm_fg,bg=$thm_gray] #W #[fg=$thm_bg,bg=$thm_orange] #I#[fg=$thm_orange,bg=default]$left_separator#[fg=$thm_fg,bg=default,nobold,nounderscore,noitalics] "
